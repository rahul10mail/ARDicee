...
//  ARDicee
//
//  Created by Rahul Kumar on 06/06/20.
...
//        self.sceneView.debugOptions = [ARSCNDebugOptions.showFeaturePoints]
    ...
    func roll(dice: SCNNode) {
        let randomX = Float(arc4random_uniform(4) + 1) * (Float.pi/2) * Float(Int.random(in: 0 ..< 10))
        let randomY = Float(arc4random_uniform(4) + 1) * (Float.pi/2) * Float(Int.random(in: 0 ..< 10))
        let randomZ = Float(arc4random_uniform(4) + 1) * (Float.pi/2) * Float(Int.random(in: 0 ..< 10))
